...
set(CLAZY_CHECKS_SRCS ${CLAZY_CHECKS_SRCS}
  ...
  ${CMAKE_CURRENT_LIST_DIR}/src/checks/manuallevel/cache-model-rolenames.cpp
  ...
  ${CMAKE_CURRENT_LIST_DIR}/src/checks/manuallevel/modernize-list-initialization.cpp
  ...
  ${CMAKE_CURRENT_LIST_DIR}/src/checks/level1/modernize-overloaded-connects.cpp
  ...
  ${CMAKE_CURRENT_LIST_DIR}/src/checks/level1/readlock-detaching.cpp
