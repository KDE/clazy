...
public:
    ...
    {
        return clazy::VisitHelper::VisitStmt(stmt, m_context, m_visitors.visitStmts);
    }

    bool VisitDecl(Decl *decl)
    {
        return clazy::VisitHelper::VisitDecl(decl, m_context, m_visitors.visitDecls, m_visitors.visitAllTypedefDecls);
    }
