...
- Checks from Level 1:
    ...
    - [range-loop-detach](docs/checks/README-range-loop-detach.md)    (fix-range-loop-detach)
    - [range-loop-reference](docs/checks/README-range-loop-reference.md)    (fix-range-loop-reference)
